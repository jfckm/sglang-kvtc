...
BENCHMARK_SIZE_LIMIT = 5
KVTC_CALIBRATION_LIMIT = 10

class TestNPUQwen3_235BA22B_1P_gsm8k_cr_8_smoke(TestAscendPerformanceKvtcTestCaseLME, CustomTestCase):
    ...
    def test_KVTC_qwen3_235b_smoke(self):
        # filling kvcache run
